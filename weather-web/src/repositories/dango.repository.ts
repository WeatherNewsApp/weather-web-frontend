...
export const dangoRepository = {
  ...
  // mybest団子
  getBestDango: () => apiClient.get<Dango>("/api/v1/dangos/me/best"),

  // 団子追加
  newDango: () => apiClient.post<ApiResponse>("/api/v1/dangos"),
  ...
  changeDangoSkin: (
    ...
    apiClient.patch<ApiResponse>("/api/v1/dangos/me/skins", {
      head_skin_id,
      body_skin_id,
      base_skin_id,
    }),
